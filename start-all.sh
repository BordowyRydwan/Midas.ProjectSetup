...
#dotnet ef database update --project Midas.Services/Authorization/src/Infrastructure/Infrastructure.csproj --startup-project Midas.Services/Authorizationsrc/WebAPI/WebAPI.csproj --context Infrastructure.Data.AuthorizationDbContext --configuration Release
